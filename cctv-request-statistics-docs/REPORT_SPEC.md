...
| เลขคำร้อง | วันที่ | ประเภทผู้ขอ | หมวดหมู่ | สถานะ | สถานที่ | ไฟล์แนบ | ส่งมอบ |
|---|---|---|---|---|---|---:|---:|
...
| รายการส่งมอบ | นับจำนวนรายการส่งมอบทั้งหมดในช่วงวันที่ที่เลือก |
| ส่งมอบตามประเภทข้อมูล | นับรายการส่งมอบแยกตามประเภทข้อมูลที่ส่งมอบ |
| ส่งมอบตามช่องทาง | นับรายการส่งมอบแยกตามช่องทางส่งมอบ (อีเมล ไลน์ รับด้วยตนเอง ฯลฯ) |
...
9. จำนวนรายการส่งมอบ
10. วันที่บันทึก
11. วันที่แก้ไขล่าสุด

Sheet เพิ่มเติม "สรุปการส่งมอบ":
| หมวด | รายการ | จำนวน |
|---|---|---:|
| ประเภทข้อมูล | ไฟล์วิดีโอจากกล้อง | 5 |
| ประเภทข้อมูล | ภาพนิ่ง/ภาพถ่ายหน้าจอ | 3 |
| ช่องทาง | อีเมล | 4 |
| ช่องทาง | ไลน์ (LINE) | 2 |
| รวม | | 8 |
...
## 7. Export Backup
ควร export เป็น Excel หลาย sheet (version 2):
- metadata
- requests
- requester_types
- categories
